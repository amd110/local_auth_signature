...
class MockLocalAuthSignaturePlatform
  ...
  @override
  Future<String?> sign({required String keyStoreAlias, required String payload, required AndroidPromptInfo androidPromptInfo, required IOSPromptInfo iosPromptInfo}) {
    // TODO: implement sign
    throw UnimplementedError();
  }

  @override
  Future<bool> verify({required String keyStoreAlias, required String payload, required String signature, required AndroidPromptInfo androidPromptInfo, required IOSPromptInfo iosPromptInfo}) {
